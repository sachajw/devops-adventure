...
SECURITY_EMAIL_SENDER = 'no-reply@pgadmin.allianz'
...
USER_INACTIVITY_TIMEOUT = os.environ.get('USER_INACTIVITY_TIMEOUT') if (os.environ.get('USER_INACTIVITY_TIMEOUT')) else 2700
...
AUTHENTICATION_SOURCES = ['oauth2', 'internal'] if (os.environ.get('GITHUB_OAUTH_ENABLED') == "True") else ['internal']
...
OAUTH2_CONFIG = [
    {
        ...
        # 'OAUTH2_DISPLAY_NAME': 'My Github',
        # # Oauth client id
        # 'OAUTH2_CLIENT_ID': 'd1cb965ad3fda8f0c5f3',
        # # Oauth secret
        # 'OAUTH2_CLIENT_SECRET': '40124e4209b4b472ccddbf96598feafd8cf45eb7',
        # # URL to generate a token,
        # # Ex: https://github.com/login/oauth/access_token
        # 'OAUTH2_TOKEN_URL': 'https://github.com/login/oauth/authorize',
